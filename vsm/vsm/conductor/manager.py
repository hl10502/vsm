...
class ConductorManager(manager.Manager):
    ...
    def rename_storage_pool(self, context, pool_id, values):
    ...
    def get_storage_pool1(self, context, id):
        LOG.info('get_storage_pool1 in conductor manager')
        return db.pool_get(context, id)

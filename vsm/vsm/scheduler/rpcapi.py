...
class SchedulerAPI(vsm.openstack.common.rpc.proxy.RpcProxy):
    ...
    def rename_storage_pool(self, ctxt, body=None):
        return self.call(ctxt, self.make_msg('rename_storage_pool', body=body))
    ...
    def install_servers(self, ctxt, body=None):
        #NOTE change this procedure to rpc.cast method()
        ret = self.cast(ctxt, self.make_msg('install_servers', body=body))
        return ret

...
from .views import InstallServersView
from .views import install_server
...
urlpatterns = patterns('',
    ...
    url(r'^installserversview/$', InstallServersView.as_view(), name='installserversview'),
    url(r'^install_server/$', install_server, name='install_server'),

...
class RenameStoragePool(tables.LinkAction):
    name = "rename pool"
    verbose_name = _("Rename Pool")
    url = "horizon:vsm:poolsmanagement:rename"
...
#    cluster = tables.Column("clusterName", verbose_name=_("Cluster"))
    ...
    class Meta:
        ...
        row_actions = (RenameStoragePool,)
        multi_select = False

    def get_object_id(self, datum):
        if hasattr(datum, "poolId"):
            return datum.poolId
        else:
            return datum["poolId"]
